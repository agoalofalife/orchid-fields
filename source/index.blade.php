...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            <h1 id="intro-docs-template" class="text-white">{{ $page->siteName }}</h1>

            <h2 id="intro-powered-by-jigsaw" class="font-light mt-4 text-white">{{ $page->siteDescription }}</h2>

            <p class="text-lg text-white">Give your documentation a boost with Jigsaw. <br class="hidden sm:block">Generate elegant, static docs quickly and easily.</p>

            <div class="flex my-10">
                <a href="/docs/en/getting-started" title="{{ $page->siteName }} getting started" class="bg-blue-500 hover:bg-blue-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Get Started</a>
...
{{--                <a href="https://jigsaw.tighten.co" title="Jigsaw by Tighten" class="bg-gray-400 hover:bg-gray-600 text-blue-900 font-normal hover:text-white rounded py-2 px-6">About Jigsaw</a>--}}
    ...
    <div class="md:flex -mx-2 -mx-4">
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            <img src="{{ mix('img/icon-window.svg', $page->pathToAssets) }}" class="h-12 w-12" alt="window icon">
        ...
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            <img src="{{ mix('img/icon-terminal.svg', $page->pathToAssets) }}" class="h-12 w-12" alt="terminal icon">
        ...
        <div class="mx-3 px-2 md:w-1/3">
            <img src="{{ mix('img/icon-stack.svg', $page->pathToAssets) }}" class="h-12 w-12" alt="stack icon">

            <h3 id="intro-mix" class="text-2xl mb-0 text-white">Compile your assets <br>using Laravel Mix </h3>

            <p class="text-white">Jigsaw comes pre-configured with Laravel Mix, a simple and powerful build tool. Use the latest frontend tech with just a few lines of code.</p>
        </div>
    </div>
</section>
@endsection

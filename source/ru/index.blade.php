...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <p class="text-lg text-white">Окунитесь в магию Orchid ✨ <br class="hidden sm:block">Использовать для форм, отображения в таблицах и везде где необходимо.</p>

            <div class="flex my-10">
                <a href="/docs/ru/getting-started" title="{{ $page->siteName }} getting started" class="bg-blue-500 hover:bg-blue-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Читать</a>
...
{{--                <a href="https://jigsaw.tighten.co" title="Jigsaw by Tighten" class="bg-gray-400 hover:bg-gray-600 text-blue-900 font-normal hover:text-white rounded py-2 px-6">About Jigsaw</a>--}}
    ...
    <div class="md:flex -mx-2 -mx-4">
        ...
        <div class="mx-3 px-2 md:w-1/3">
            ...
            <h3 id="intro-mix" class="text-2xl mb-0 text-white">Расширяйте своими полями</h3>
